...
const GroupCalendar = (props: any) => {
  ...
  const shownEvents = prepareEvents(props.events);
  ...
  return (
    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <CalendarComponent personal={false} events={props.events} uid={uid} admin={admin} gid={group.id} navigation={props.navigation}/>
    </View>
  );
}
